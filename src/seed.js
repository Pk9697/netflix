export default async function seedDatabase(firebaseDb, collection, addDoc) {
  /* Series
    ============================================ */
  // Documentaries
  try {
    await addDoc(collection(firebaseDb, 'series'), {
      title: 'Tiger King',
      description:
    ...
    /* Films
      ============================================ */
    // Drama
    await addDoc(collection(firebaseDb, 'films'), {
      title: 'The Prestige',
      description:
